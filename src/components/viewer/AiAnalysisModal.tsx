...
export function AiAnalysisModal() {
  ...
  const handlePrint = useCallback(() => {
    ...
    // Render markdown to HTML using ReactMarkdown by reading the already-rendered content
    const renderedContent = document.getElementById('ai-analysis-rendered-content')
    ...
    const printStyles = `
      ...
      h1 { font-size: 1.6rem; font-weight: 700; margin: 0 0 0.5rem 0; color: #111; }
      h2 { font-size: 1.35rem; font-weight: 600; margin: 1.8rem 0 0.75rem 0; color: #222; border-bottom: 1px solid #e5e5e5; padding-bottom: 0.3rem; }
      h3 { font-size: 1.15rem; font-weight: 600; margin: 1.5rem 0 0.5rem 0; color: #333; }
      h4 { font-size: 1rem; font-weight: 600; margin: 1.25rem 0 0.5rem 0; color: #444; }
      p { margin: 0.75rem 0; }
      ...
      hr { border: none; border-top: 1px solid #ddd; margin: 1.75rem 0; }
      code { background: #f5f5f5; padding: 2px 5px; border-radius: 3px; font-size: 0.88em; font-family: 'SFMono-Regular', Consolas, monospace; }
      pre { background: #f5f5f5; padding: 14px; border-radius: 6px; overflow-x: auto; margin: 1rem 0; }
...
<html>
  ...
  <body>
    ...
    // Use a hidden iframe for printing - works in both browser and Tauri
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {viewMode === 'rendered' ? (
            <div
              ...
              className="prose prose-invert max-w-none prose-headings:text-gray-100 prose-headings:font-semibold prose-h1:text-xl prose-h1:mb-3 prose-h1:mt-0 prose-h2:text-lg prose-h2:mt-8 prose-h2:mb-3 prose-h2:pb-2 prose-h2:border-b prose-h2:border-[#333] prose-h3:text-base prose-h3:mt-6 prose-h3:mb-2 prose-h4:text-sm prose-h4:mt-5 prose-h4:mb-2 prose-p:text-gray-300 prose-p:leading-relaxed prose-p:my-3 prose-strong:text-gray-200 prose-strong:font-semibold prose-li:text-gray-300 prose-li:my-1 prose-ul:my-3 prose-ol:my-3 prose-a:text-blue-400 prose-a:no-underline hover:prose-a:underline prose-code:text-gray-200 prose-code:bg-[#0a0a0a] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-pre:bg-[#0a0a0a] prose-pre:border prose-pre:border-[#2a2a2a] prose-pre:rounded-lg prose-hr:border-[#333] prose-hr:my-6 prose-blockquote:border-l-blue-500 prose-blockquote:text-gray-400 prose-table:text-sm prose-th:text-gray-200 prose-th:bg-[#0a0a0a] prose-td:text-gray-300 prose-td:border-[#333] prose-th:border-[#333]"
            >
